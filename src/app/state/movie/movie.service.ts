...
export class MovieService {
  ...
  addToWatchList(movie: Movie): void {
    ...
    localStorage.setItem('watchList', this.moviesRepository.onWatchList.toString());

  }

  removeFromWatchList(movie: Movie): void {
    this.moviesRepository.removeFromWatchList(movie);
    localStorage.setItem('watchList', JSON.stringify(this.moviesRepository.onWatchList));
  }
}
